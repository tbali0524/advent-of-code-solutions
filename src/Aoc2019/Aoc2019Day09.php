 ...
 */
final class Aoc2019Day09 extends SolutionBase
{
    public const YEAR = 2019;
    public const DAY = 9;
    public const TITLE = 'Sensor Boost';
    public const SOLUTIONS = [3454977209, 50120];
    public const EXAMPLE_SOLUTIONS = [[1125899906842624, 0]];
    ...
    public function solve(array $input): array
    {
        ...
        // ---------- Part 1
        $boost = new BoostSimulator($memory);
        $boost->inputs[] = 1;
        $boost->simulate();
        $ans1 = $boost->outputs[count($boost->outputs) - 1];
        // ---------- Part 2
        $boost = new BoostSimulator($memory);
        $boost->inputs[] = 2;
        $boost->simulate();
        $ans2 = $boost->outputs[count($boost->outputs) - 1];
        return [strval($ans1), strval($ans2)];
    }
}

// --------------------------------------------------------------------
final class BoostSimulator
{
